...
5. La base de datos utilizada es MySql. La base en si se denomino Challenge y la tabla bulkuploadtable. La base y la tabla usada puede ser generada por el siguiente script:
